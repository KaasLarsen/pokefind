...
- **`feeds.json`** — Jeres faste Partner-ads feed-URL’er (én `url` pr. butik/feed). Repoet indeholder **10 feeds** (samme `partnerid`, forskellige `bannerid`/`feedid`) som i chat-historikken.
